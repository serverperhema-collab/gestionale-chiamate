...
export default function TLAlertProvider() {
  ...
  return (
    <>
      <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[100] flex items-center bg-gray-800/90 backdrop-blur-md border border-gray-700 rounded-full px-4 py-2 shadow-2xl print:hidden">
