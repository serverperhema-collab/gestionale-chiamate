...
export default function TLAlertProvider() {
  ...
  return (
    <>
      <div className="fixed top-[20px] left-1/2 transform -translate-x-1/2 z-[100] flex items-center bg-gray-800/90 backdrop-blur-md border border-gray-700 rounded-full px-4 py-1.5 shadow-lg">
