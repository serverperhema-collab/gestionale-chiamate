...
export default function GlobalContactsPage() {
  ...
  const getStatusBadge = (c: any) => {
    ...
    if (c.trattativa && c.trattativa.status === 'APPUNTAMENTO') {
      return <span className="px-2 py-1 bg-blue-500/20 text-blue-400 rounded text-xs font-semibold">APPUNTAMENTO FISSATO</span>;
    }
