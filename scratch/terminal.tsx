...
export default function OperatorTerminal() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (data.error !== "Nessun contatto disponibile per i CAP assegnati.") {
            // Evitiamo di mostrare il toast per i blocchi, dato che la UI mostra giÃ  la schermata rossa "Sei Bloccato"
  ...
  const handleAutoSave = async (field: keyof typeof tempFields, value: string) => {
    ...
    // Controlla se il valore Ã¨ effettivamente cambiato rispetto al DB
    let originalValue = "";
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center mt-32 bg-red-900/20 p-8 rounded-2xl border border-red-500 max-w-md text-center">
            ...
            <p className="text-gray-300 font-medium">
              Il tuo account Ã¨ stato sospeso a tempo indeterminato dalla Team Leader. Non puoi accedere a nessun contatto.
            </p>
          ...
          <div className="w-full max-w-4xl space-y-6">
            ...
            {(modLocked || skipLocked || noAnswerLocked || notAvailableLocked) && (
              <div className="bg-red-900/50 border border-red-500 text-red-200 p-4 rounded-xl flex flex-col gap-1">
                ...
                {modLocked && <p>â€¢ Hai superato il limite di modifiche giornaliere consentite su dati preesistenti. Campi disabilitati.</p>}
                {skipLocked && <p>â€¢ Hai effettuato troppi Skip consecutivi. Funzione Skip disabilitata.</p>}
                {noAnswerLocked && <p>â€¢ Hai cliccato troppi "Non Risponde" ravvicinati. Funzioni bloccate temporaneamente per controlli anti-frode.</p>}
                {notAvailableLocked && <p>â€¢ Hai cliccato troppi "Non Reperibile" ravvicinati. Funzioni bloccate temporaneamente per controlli anti-frode.</p>}
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button disabled={noAnswerLocked} onClick={() => { setReviewNotes(""); setReviewModalOpen(true); }} className="px-6 py-3 bg-indigo-900/30 text-indigo-400 hover:bg-indigo-800 hover:text-white border border-indigo-700/50 rounded-lg transition shadow-sm disabled:opacity-50 flex flex-col items-center justify-center gap-1">
                    ...
                    <span className="text-xs italic opacity-85 font-normal">contatto giÃ  gestito o anomalo</span>
                  </button>
                    {!contact.isGestioneSeparata && (
                      <button disabled={noAnswerLocked} onClick={() => { setGestioneSeparataNotes(""); setGestioneSeparataModalOpen(true); }} className="px-6 py-3 bg-teal-900/30 text-teal-400 hover:bg-teal-800 hover:text-white border border-teal-700/50 rounded-lg transition shadow-sm disabled:opacity-50 flex flex-col items-center justify-center gap-1">
                        ...
                        <span className="text-xs italic opacity-85 font-normal">invia alla societÃ  di pulizie</span>
                      </button>
                    )}
                </div>
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[100] p-4 backdrop-blur-sm">
            <div className="bg-gray-800 rounded-xl border border-teal-500/30 w-full max-w-md p-6 shadow-2xl relative">
              ...
              <p className="text-sm text-gray-300 mb-4 leading-relaxed">
                ...
                Inserisci una nota per il Team Leader che dovrÃ  approvare la richiesta.
              </p>
              <textarea
      ...
      {trashModalOpen && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-xl border border-gray-700 w-full max-w-md p-6 shadow-2xl">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Sei sicuro che questo contatto sia completamente inutile (es. chiuso, inesistente, privato)? Inserisci il motivo. La richiesta verrÃ  valutata dal Team Leader.
            </p>
            <textarea
              autoFocus
              ...
              placeholder="Spiega brevemente perchÃ© il contatto Ã¨ da eliminare..."
              value={trashNotes}
      ...
      {reviewModalOpen && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-xl border border-gray-700 w-full max-w-md p-6 shadow-2xl">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Pensi che questo contatto sia giÃ  stato gestito o presenti anomalie da segnalare al Team Leader? La richiesta verrÃ  valutata ed eventualmente sbloccata o archiviata.
            </p>
            <textarea
              autoFocus
              ...
              placeholder="Specifica perchÃ© richiedi la revisione (es: 'giÃ  gestito da Hema', 'telefono privato', 'ragione sociale errata')..."
              value={reviewNotes}
          ...
          <div className="bg-gray-800 rounded-xl border border-gray-700 w-full max-w-md p-6 shadow-2xl">
            ...
            {outcomeType === "NON_INTERESSATO" && (
              <div className="mb-4 bg-red-950/20 border border-red-900/50 p-3 rounded-lg text-xs text-red-300">
                Il contatto verrÃ  nascosto dal calderone e non potrÃ  essere chiamato da nessuno per 3 mesi (90 giorni).
              </div>
            )}
            ...
            <textarea
              ...
              placeholder={outcomeType === "NON_INTERESSATO" ? "Specifica il motivo del disinteresse (es: prezzi alti, lavorano giÃ  con altri)..." : "es. segreteria, occupato, mi ha detto di riprovare..."}
              value={outcomeNotes}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-xl border border-gray-700 w-full max-w-md p-6 shadow-2xl">
            ...
            <textarea
              ...
              placeholder="Di cosa avete parlato? PerchÃ© va richiamato?"
              value={negoNotes}
          ...
          <div className="bg-gray-800 rounded-2xl border-2 border-orange-500 w-full max-w-md p-6 shadow-2xl relative">
            ...
            <div className="text-center mt-6">
              ...
              <p className="text-sm text-gray-400 mb-6">
                Ãˆ arrivato il momento di richiamare questo cliente come programmato.
              </p>
