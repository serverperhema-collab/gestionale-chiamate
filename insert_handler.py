...
target = """  const handleOutcome = async (outcome: string, notes: string = "", recallDateStr?: string) => {"""
replacement = """  const handleGestioneSeparataRequest = async () => {
...
if "const handleGestioneSeparataRequest =" not in code:
