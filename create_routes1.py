...
base_dir = "src/app/api/trattative"
os.makedirs(f"{base_dir}/[id]/actions", exist_ok=True)
os.makedirs(f"{base_dir}/[id]/attachments", exist_ok=True)
os.makedirs(f"{base_dir}/[id]/events", exist_ok=True)

route_root = """import { NextResponse } from "next/server";
